...
_main_menu_ru.add(get_string('main_menu.make_order'), get_string('main_menu.send_comment'))
_main_menu_ru.add(get_string('main_menu.language'), get_string('main_menu.about'))
...
_main_menu_uz.add(get_string('main_menu.make_order', 'uz'), get_string('main_menu.send_comment', 'uz'))
_main_menu_uz.add(get_string('main_menu.language', 'uz'), get_string('main_menu.about', 'uz'))
